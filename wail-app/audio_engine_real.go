...
const (
	...
	// some Link Audio receivers stall on (DAW-bridge plugins in particular have
	// choked on any feed-ahead), so the default was briefly 0 — floored to one
	// ~5ms write chunk, the minimum that still emits. Field testing (2026-07-23) showed
