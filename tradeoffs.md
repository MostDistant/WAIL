...
**Status:** Decided (implemented; `ipcLeadMs = 20` fixed, not configurable)
...
**Status:** Decided (implemented; field validation pending)
...
**Status:** Decided (implemented; `WAIL_IPC_SEND_LEAD_MS`, default 10 ms, clamped 0–50)
