...
## 5.0.0-beta.0 (2026-08-01)

### Breaking Changes

- sender-relative rounds — the client side of ADR-0009 (#512)
...
- slew from the observed tempo, and adopt sender-relative rounds (ADR-0008) (#510)

## 4.2.0-beta.2 (2026-08-01)
...
- add Ableton Link interval clock to the session UI (#382)
...
- docs: record that wail-signal was destroyed (pre-3.2.0 clients must upgrade) (#360)
